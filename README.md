...
| 연계 프로젝트 | [유전체 정보 품종 분류](https://github.com/Minsu5452/genomic-breed-classification) |
...
제한된 표본과 클래스 불균형이 있는 SNP 분류 문제에서 파생 변수 설계부터 불균형 보정, voting 앙상블까지 적용한 과정을 정리했습니다. 상세 실험과 최종 경진대회 솔루션은 [유전체 정보 품종 분류](https://github.com/Minsu5452/genomic-breed-classification) 저장소에 있습니다.

## 공개 범위

원본 대회 데이터와 생성 산출물은 포함하지 않았습니다. 이 저장소는 경진대회 전체 솔루션이 아니라 학술대회 발표와 논문 기록을 보관하는 용도입니다.
